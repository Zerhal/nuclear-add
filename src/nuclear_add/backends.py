...
from typing import Union, Sequence, Optional, Any, Callable, TYPE_CHECKING
...
class CuPyBackend(Backend):
    ...
    _cp = None
    _device_info: Optional[str] = None
    ...
    def _check_available(self):
        try:
            ...
            try:
                self._cp.cuda.Device(0).compute_capability
...
class NumbaBackend(Backend):
    ...
    _numba = None
    _jit_add: Optional[Callable] = None
    _jit_kahan: Optional[Callable] = None
...
class BackendDispatcher:
    ...
    def select_backend(self, data_size: int, needs_precision: bool = False) -> Backend:
        ...
        if self.prefer_gpu and self._backends["cupy"].is_available():
    ...
    def add(self, a: Any, b: Any, **hints) -> Any:
