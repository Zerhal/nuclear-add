...
class NumericTracer:
    ...
    @contextmanager
    def trace(self, context: Optional[Dict[str, Any]] = None):
...
class PrecisionAnalyzer:
    ...
    def __init__(self, tracer: Optional[NumericTracer] = None):
    ...
    def check_addition(self, a: float, b: float, result: float) -> Optional[ErrorEvent]:
        """
...
class OverflowDetector:
    ...
    @classmethod
    def safe_add(cls, a: float, b: float) -> tuple[float, Optional[str]]:
        """
...
_global_tracer: Optional[NumericTracer] = None
